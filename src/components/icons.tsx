...
export const Icons = {
	...
	home: ({ ...props }: IconProps) => (
		...
		>
			<path
				fill="currentColor"
				d="m12.71,2.29c-.39-.39-1.02-.39-1.41,0L3.29,10.29c-.19.19-.29.44-.29.71v9c0,1.1.9,2,2,2h4c.55,0,1-.45,1-1v-6h4v6c0,.55.45,1,1,1h4c1.1,0,2-.9,2-2v-9c0-.27-.11-.52-.29-.71L12.71,2.29Zm3.29,17.71v-5c0-1.1-.9-2-2-2h-4c-1.1,0-2,.9-2,2v5h-3v-8.59l7-7,7,7v8.59s-3,0-3,0Z"
			/>
		</svg>
	),
	...
	search: ({ ...props }: IconProps) => (
		...
		>
			<path
				fill="currentColor"
				d="M16.334 4.667a8.25 8.25 0 0 1 .506 11.114l3.94 3.94.027.027a.75.75 0 0 1-1.06 1.06l-.027-.027-3.94-3.94a8.25 8.25 0 1 1 .554-12.174M5.727 5.728a6.75 6.75 0 1 0 9.546 9.546 6.75 6.75 0 0 0-9.546-9.546"
			/>
		</svg>
	),
